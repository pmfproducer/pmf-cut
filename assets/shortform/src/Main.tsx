...
export const DynamicVideo: React.FC<{src?: string; frameOffset?: number; transparent?: boolean; children?: React.ReactNode}> = ({
  ...
  return (
    <AbsoluteFill>
      ...
      >
        <OffthreadVideo src={staticFile(src)} transparent={transparent} style={{width, height, objectFit: 'cover'}} />
        {children}
      </div>
    </AbsoluteFill>
  );
...
// Ponto, virgula e reticencias sao ruido numa legenda de uma linha — a propria
// quebra ja marca a pausa. INTERROGACAO e EXCLAMACAO nao: elas mudam o sentido.
// "como eu falo com os meus seguidores" e uma afirmacao; "…seguidores?" e a
// pergunta que o roteiro esta fazendo, e sem o sinal a legenda contradiz a fala.
// `isBreak` continua olhando TODA a pontuacao — ela decide onde a linha quebra,
// que e outra pergunta: um ponto final segue sendo fim de frase mesmo sem ser
// desenhado.
